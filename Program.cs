  ...
  ");
                            ...
                            switch (opcaoPf)
                            {
                                case "1":
                                    ...
                                    pfMetodos.VerificaPastaArquivo(pfMetodos.caminho);
                                    pfMetodos.Inserir(novaPf);
                                ...
                                case "2":
                                    ...
                                    // using (StreamReader sr = new StreamReader("fulano.txt"))
                                    // {
                                    //     string linha;
                                    ...
                                    List<PessoaFisica> listPf = pfMetodos.Ler();
